...
<section id="firstView" class="h-screen w-screen">
    ...
    <div class="modify-f-view">
        <div class="w-full h-5/6">
            <picture>
                <source media="(max-width:420px)" srcset="{{ asset('image/sm_first_view_750x850_01.jpg') }}">
                <img class="h-full w-full object-cover filter blur-sm" src="{{ asset('image/first_view_3000x1700_01.jpg') }}" >
            </picture>
        </div>
...
<section id="description" class="flex justify-center items-center h-screen w-screen bg-blue-50">
    <div class="container text-center">
        ...
        <img src="{{ asset('image/usb_memory.png') }}" class="transform sm:scale-100 scale-90 block mx-auto h-32 w-32 " alt="" srcset="">
    </div>
</section>
